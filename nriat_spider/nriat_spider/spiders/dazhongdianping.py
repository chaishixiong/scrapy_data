...
class DianPingSpider(RedisSpider):
    ...
    custom_settings = {"DOWNLOAD_DELAY":0.5,"CHANGE_IP_NUM":200,"DOWNLOADER_MIDDLEWARES" : {'nriat_spider.middlewares.DaZhongDianPingDownloaderMiddleware': 20,
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(url=url, callback=self.get_city, method="GET",headers=headers)
