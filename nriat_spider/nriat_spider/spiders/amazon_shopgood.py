...
class AmazonShopGoods(RedisSpider):
    ...
    error_key = "amazon_shopgoods:error_key"
...
upgrade-insecure-requests: 1'''
    def make_requests_from_url(self,seed):
        ...
        return scrapy.Request(url=url, method="GET", headers=headers_todict(self.headers),meta={"id":id,"proxy":"127.0.0.1:8080"},dont_filter=True)
