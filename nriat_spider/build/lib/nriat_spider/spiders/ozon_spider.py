...
import json
from ..items import Ozon1Item

from scrapy_redis.spiders import RedisSpider

class OnzonSpiderSpider(RedisSpider):
    name = 'ozon_spider'
    allowed_domains = ['ozon.ru']
    # start_urls = ['https://www.ozon.ru/']

    redis_key = 'ozon1:start_urls'
    ...
    def start_requests(self):
        with open(r'W:/lxd/ozon1/{cat_url}[cat_url].txt','r',encoding='utf-8') as f:
            for i in tqdm(f):
                i = i.replace('\n', '')
                page = 1
                url = i + '?page='
