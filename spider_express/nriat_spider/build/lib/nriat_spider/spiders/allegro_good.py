    ...
    def parse(self, response):
        ...
        if youxiao:
            ...
            try:
                ...
                huobi_type = huobi_type.get('sellingMode', {}).get('buyNow',{}).get('price',{}).get('sale',{}).get('currency',{})
            except:
                huobi_type = ''
            items = AllegroItem(shop_id=shop_id,shop_super=shop_super,shop_name=shop_name,positive_feedback=positive_feedback,
                                positive_number=positive_number,ratingCountLabel=ratingCountLabel,huobi_type=huobi_type)
            yield items
        else:
