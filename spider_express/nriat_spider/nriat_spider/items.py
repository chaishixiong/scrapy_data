...
class GmWorkItem(scrapy.Item):
    ...
    puretitle = scrapy.Field()
    productUrl = scrapy.Field()
    originalPriceFrom = scrapy.Field()
    originalPriceTo = scrapy.Field()
    unit = scrapy.Field()
    minOrder = scrapy.Field()
    supplierKey = scrapy.Field()
    supplierYear = scrapy.Field()
    supplierCountry = scrapy.Field()
    supplierProvince = scrapy.Field()
    supplierName = scrapy.Field()
    supplierHref = scrapy.Field()
    supplierProductListHref = scrapy.Field()
    expCountry = scrapy.Field()
    conducted = scrapy.Field()
    num = scrapy.Field()
    tradeAssurance = scrapy.Field()
    transactionLevel = scrapy.Field()
    responseRate = scrapy.Field()
    responseTime = scrapy.Field()
    reviewLink = scrapy.Field()
    reviewScore = scrapy.Field()
    reviewCount = scrapy.Field()
    catname_1 = scrapy.Field()
    catname_2 = scrapy.Field()
    catname_3 = scrapy.Field()
...
class AmazonItem(scrapy.Item):
    ...
    html = scrapy.Field()
    goodrate_mouth_info = scrapy.Field()
    middlerate_mouth_info = scrapy.Field()
    badrate_mouth_info = scrapy.Field()
    comment_mouth_info = scrapy.Field()
    goodrate_quarterly = scrapy.Field()
    middlerate_quarterly = scrapy.Field()
    badrate_quarterly = scrapy.Field()
    comment_quarterly = scrapy.Field()
    goodrate_year = scrapy.Field()
    middlerate_year = scrapy.Field()
    badrate_year = scrapy.Field()
    comment_year = scrapy.Field()
    goodrate_total = scrapy.Field()
    middlerate_total = scrapy.Field()
    badrate_total = scrapy.Field()
